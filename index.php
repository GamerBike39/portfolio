...
<body>
    ...
    <div id="containerHome" class="home">
            ...
            <div class="info">
                <div class="left flex">
                    <div class="contact flex">
                        ...
                        <ul>
                            <li> France Jura</li>
                            <li class="email"><a href="mailto:julien.mathieu86@orange.fr"><strong>julien.mathieu86@orange.fr</strong>
                                </a></li>
                        </ul>
                    </div>
                    <nav class="links">
        ...
        <div class="containerProject">
            <h3 class="btn-modalPop"  >POPCODE</h3>
    ...
    <div class="modal modalPop displayNone">
        ...
        <div class="flexJCCAIC">
           ...
           <div class="modalGit">
            ...
            <a class='modalLink' href='https://gamerbike39.github.io/ProjectPopCode/' target='_blank'>Visiter le
                site</a>
        </div>
    </div>

    <div id="apropos" class="containerAbout flex displayNone">
    ...
    <div class="contact">
        <div class="containerContact displayNone" id="contact">
            <h4>Contact</h4>
            ...
            <div class="formulaire">
                <form method="post" action="contact.php">
                    ...
                    <!-- <button  type="submit" onclick="sendData({test:'ok'})" class="btn">Envoyer</button> -->
                    <button type="submit" onclick="sendData({test:'ok'})" class="btn">
                        <span class="front text">Envoyer</span>
                      </button>
                      <span class="reponseEnvoie"></span>
                </form>
            </div>
        </div>
    </div>
...
?>
    ...
    <script src="assets/js/mailSend.js"></script> 
